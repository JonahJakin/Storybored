...
let background = NSColor(calibratedRed: 0xE9 / 255.0, green: 0xE0 / 255.0, blue: 0xD2 / 255.0, alpha: 1)
let badgeFill = NSColor(calibratedRed: 0xF1 / 255.0, green: 0xEA / 255.0, blue: 0xDF / 255.0, alpha: 1)
